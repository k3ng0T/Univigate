...
const UNIVERSITIES = {
  NU: {
    ...
    info: {
      description:
        "Nazarbayev University — автономный исследовательский университет мирового класса, работающий по модели американских исследовательских университетов. Обучение ведётся исключительно на английском языке.",
      type: "Автономный",
      founded: 2010,
      students: 6000,
      location: {
    ...
    exchangePrograms: [
      "Academic/Student Exchange — семестровый обмен для студентов",
      "Членство в сетях Asian Universities Alliance, University Alliance of the Silk Road — для академической мобильности и сотрудничества",
    ],

    partnerUniversities: [
      "ADA University (Азербайджан)",
      "Aegean University (Греция)",
      "University of Valencia (Испания)",
      "Basilicata University (Италия)",
      "Bern University (Швейцария)",
      "Bremen University (Германия)",
      "Chinese University of Hong Kong – Shenzhen (Китай)",
      "и другие партнёры NU",
    ],
  ...
  KBTU: {
    ...
    info: {
      description:
        "КБТУ — ведущий технический университет Казахстана, созданный совместно с British Council. Один из топовых вузов в области IT и нефтегазовой инженерии.",
      type: "Частный",
      founded: 2001,
      students: 5000,
      location: {
    ...
    exchangePrograms: [
      "Academic mobility / international outgoing mobility — семестр/год обучения в зарубежных вузах-партнёрах",
    ],

    partnerUniversities: [
      "University of Salerno (Италия)",
      "Tallinn University of Technology (Эстония)",
      "Партнёры по IT/IoT/AI/робототехнике",
      "Участие в United Nations Academic Impact (UNAI) для международных связей",
    ],
  ...
  KazNU: {
    ...
    info: {
      description:
        "КазНУ — крупнейший и старейший университет Казахстана. Входит в топ-200 QS World University Rankings. Предлагает широкий спектр программ.",
  ...
  KIMEP: {
    ...
    info: {
      description:
        "KIMEP — старейший частный университет в Центральной Азии, работающий по североамериканской модели. Лидер в бизнес-образовании.",
      type: "Частный",
      founded: 1992,
      students: 3000,
      location: {
    ...
    requirements: {
      ...
      entRequired: false,
      entNote:
        "ЕНТ принимается, основной отбор через SAT и внутренние экзамены",
    },
  ...
  AstanaIT: {
    ...
    info: {
      description:
        "AITU — специализированный IT-университет нового поколения. Центр цифровых инноваций и технологического предпринимательства.",
      type: "Частный",
      founded: 2017,
      students: 2500,
      location: {
        ...
        coordinates: { lat: 51.089, lng: 71.418 },
      },
    ...
    programs: {
      ...
      doctorate: ["Computer Science", "Information Systems", "Cybersecurity"],
    },
  ...
  MUIT: {
    ...
    info: {
      description:
        "МУИТ — ведущий IT-университет Казахстана в Алматы. Специализируется на IT, телекоммуникациях и цифровых медиа.",
      type: "Частный",
      founded: 2009,
      students: 4000,
      location: {
  ...
  Satbayev: {
    ...
    info: {
      description:
        "Satbayev University — ведущий технический университет Казахстана. Топ-500 QS. Специализируется на инженерии, горном деле, нефтегазе.",
      type: "Государственный",
      founded: 1934,
      students: 15000,
      location: {
  ...
  SDU: {
    ...
    info: {
      description:
        "SDU — международный частный университет с широким выбором программ (125+ бакалавриат). Известен академическим разнообразием.",
      type: "Частный",
      founded: 1996,
      students: 7000,
      location: {
    ...
    scholarships: {
      ...
      international: ["Erasmus+", "Mevlana", "Обучение в вузах-партнёрах"],
    },
  ...
  Narxoz: {
    ...
    info: {
      description:
        "Нархоз — ведущий экономический университет Казахстана. Один из старейших экономических вузов страны.",
      type: "Частный",
      founded: 1963,
      students: 5000,
      location: {
        ...
        coordinates: { lat: 43.21, lng: 76.85 },
      },
  ...
  DMUK: {
    ...
    info: {
      description:
        "DMUK — первый британский университет в Казахстане. Студенты получают британский диплом, признанный в 196 странах.",
      type: "Частный",
      founded: 2021,
      students: 500,
      location: {
        ...
        coordinates: { lat: 43.22, lng: 76.93 },
      },
  ...
  MNU: {
    ...
    info: {
      description:
        "MNU (бывший КАЗГЮУ) — ведущий юридический университет Казахстана. Специализируется на праве, бизнесе и государственном управлении.",
      type: "Частный",
      founded: 1994,
      students: 3500,
      location: {
    ...
    programs: {
      ...
      doctorate: ["Юриспруденция", "Экономика", "Государственное управление"],
    },
  ...
  ATU: {
    ...
    info: {
      description:
        "АТУ — технический университет, специализирующийся на пищевых технологиях, лёгкой промышленности и инженерии.",
      type: "Частный",
      founded: 1957,
      students: 4000,
      location: {
        ...
        coordinates: { lat: 43.24, lng: 76.91 },
      },
    ...
    accreditations: ["IQAA", "Государственная лицензия МОН РК"],
...
function getUniversitiesByDirection(direction) {
  return Object.values(UNIVERSITIES).filter(
    (uni) => uni.directions && uni.directions.includes(direction)
  );
}
...
function findProgramsByDirection(university, directionKey) {
  ...
  if (!direction || !university.programs)
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = {
    UNIVERSITIES,
    DIRECTIONS,
    getUniversitiesArray,
    getUniversityById,
    filterUniversities,
    findProgramsByDirection,
    getENTScoresForDirection,
  };
}
